...
class GameLarge extends Game {
    ...
    constructor(opening, idNumber, parentElement, callback) {
        ...
        this.createChessBoard(opening); // Creates and populates the Board() object
    ...
    createChessBoard(opening) {
        console.log(`\tFunc: createChessBoard (Game)`);
    ...
    refreshChessBoard(fen) {
        console.log(`\tFunc: refreshChessBoard (Game)`);
        this.board = null
        this.board = new BoardInteractive(0, this.element, fen);
        this.addInfoToElement()
    };
