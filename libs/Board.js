...
class Board {
    ...
    constructor(idNumber, parentElement) {
        ...
        this.#idNumber = idNumber       // Id number to assist with locating Board() in the DOM
        this.#grid = [];                // Holds all the Square() Objects.
...
export {Board, BoardDisplay, BoardInteractive};
